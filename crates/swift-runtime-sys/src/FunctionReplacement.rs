...
extern "C" {
    #[link_name = "\u{1}_swift_getFunctionReplacement"]
    pub fn swift_swift_getFunctionReplacement(
        ReplFnPtr: *mut *mut ::std::os::raw::c_char,
        CurrFn: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    #[link_name = "\u{1}_swift_getOrigOfReplaceable"]
    pub fn swift_swift_getOrigOfReplaceable(
        OrigFnPtr: *mut *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
