...
SOURCES="SwiftUIHelper.swift SnapshotHelper.swift Platform.swift AppHost.swift RealityKitHelper.swift DataHelper.swift FrameworkHelpers.swift ChartsHelper.swift FoundationModelsHelper.swift FoundationBridge.swift SecurityBridge.swift CoreAnimationBridge.swift AccelerateBridge.swift CoreMediaBridge.swift AudioToolboxBridge.swift CoreLocationBridge.swift UserNotificationsBridge.swift ContactsBridge.swift StoreKitBridge.swift AppKitBridge.swift"
