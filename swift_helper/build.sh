...
# RealityKitHelper.swift is compiled separately by crates/realitykit-sys/build.rs
# into its own librealitykit_bridge.dylib — do NOT include it here to avoid duplicate symbols.
SOURCES="SwiftUIHelper.swift SnapshotHelper.swift Platform.swift AppHost.swift DataHelper.swift FrameworkHelpers.swift ChartsHelper.swift FoundationModelsHelper.swift"
